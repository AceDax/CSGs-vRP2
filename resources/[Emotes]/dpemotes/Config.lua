...
-- You can disable the Ragdoll keybinding here.
	...
	RagdollKeybind = 137, -- Get the button number here https://docs.fivem.net/game-references/controls/
...
Config.Languages = {
  ['en'] = {
        ...
        ['cancelemoteinfo'] = "~r~G~w~ Cancels the currently playing emote",
        ...
        ['camera'] = "Press ~y~E~w~ to use camera flash.",
        ['makeitrain'] = "Press ~y~E~w~ to make it rain.",
        ['pee'] = "Hold ~y~E~w~ to pee.",
        ['spraychamp'] = "Hold ~y~E~w~ to spray champagne",
        ['bound'] = "Bound ",
        ['to'] = "to",
