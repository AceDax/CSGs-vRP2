...
local helicam = false
local newsheli2_hash = GetHashKey("newsheli2")
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPlayerInnewsheli2() and target_vehicle and not helicam and vehicle_display ~=2 then
...
function IsPlayerInnewsheli2()
	local lPed = GetPlayerPed(-1)
	local vehicle = GetVehiclePedIsIn(lPed)
	return IsVehicleModel(vehicle, newsheli2_hash)
end
