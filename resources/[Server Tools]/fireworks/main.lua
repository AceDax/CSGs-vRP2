...
AddEventHandler('frobski-fireworks:start', function()
	...
	local part1 = StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_starburst", firecoords, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
	--local part1 = StartNetworkedParticleFxNonLoopedAtCoord("scr_indep_firework_shotburst", firecoords, 0.0, 0.0, 0.0, 1.0, false, false, false, false)
	times = times - 1
	Citizen.Wait(2000)
	until(times == 0)
	DeleteEntity(box)
